...
const formSchema = z.object({
    ...
    permissions: z.object({
        ...
        shepherdingView: z.boolean().default(false),
        shepherdingManage: z.boolean().default(false),
        assignmentHistoryView: z.boolean().default(false),
        assignmentHistoryManage: z.boolean().default(false),
        bibleStudyView: z.boolean().default(false),
        bibleStudyManage: z.boolean().default(false),
        publisherGoals: z.boolean().default(true),
        publisherRecords: z.boolean().default(false),
        literature: z.boolean().default(false),
        theocraticSchool: z.boolean().default(false),
...
const permissionGroups = [
    ...
    },
    {
        ...
        icon: Users,
        permissions: [
            { key: "shepherdingView", label: "View Shepherding Calls", description: "View shepherding call records" },
            { key: "shepherdingManage", label: "Manage Shepherding", description: "Create and manage shepherding calls" },
            { key: "assignmentHistoryView", label: "View Assignment History", description: "View meeting assignment history" },
            { key: "assignmentHistoryManage", label: "Manage Assignment History", description: "Manage assignment records" },
            { key: "bibleStudyView", label: "View Bible Studies", description: "View bible study progress" },
            { key: "bibleStudyManage", label: "Manage Bible Studies", description: "Create and manage bible studies" },
            { key: "publisherGoals", label: "Publisher Goals", description: "Track personal ministry goals" },
            { key: "publisherRecords", label: "Publisher Records (S-21)", description: "Access publisher record cards" },
            { key: "literature", label: "Literature Inventory", description: "Manage literature stock and placements" },
            { key: "theocraticSchool", label: "Theocratic School", description: "Manage school assignments and progress" },
            { key: "emergency", label: "Emergency System", description: "Access emergency contacts and alerts" },
            { key: "expenses", label: "Expense Management", description: "Submit and approve expense requests" }
        ]
    },
    {
...
const presetRoles = [
    {
        ...
        permissions: {
            ...
            shepherdingView: true,
            shepherdingManage: true,
            assignmentHistoryView: true,
            assignmentHistoryManage: true,
            bibleStudyView: true,
            bibleStudyManage: true,
            publisherGoals: true,
            publisherRecords: true,
            literature: true,
            theocraticSchool: true,
            emergency: true,
            expenses: true,
            cleaning: true,
            transport: true,
    ...
    },
    {
        ...
        permissions: {
            ...
            shepherdingView: true,
            shepherdingManage: false,
            assignmentHistoryView: true,
            assignmentHistoryManage: false,
            bibleStudyView: true,
            bibleStudyManage: true,
            publisherGoals: true,
            publisherRecords: false,
            literature: true,
            theocraticSchool: true,
            emergency: false,
            expenses: false,
    ...
    },
    {
        ...
        permissions: {
            ...
            coVisitManage: false,
            coVisitSchedule: false,
            shepherdingView: false,
            shepherdingManage: false,
            assignmentHistoryView: false,
            assignmentHistoryManage: false,
            bibleStudyView: false,
            bibleStudyManage: false,
            publisherGoals: true,
            publisherRecords: false,
            literature: false,
            theocraticSchool: false,
