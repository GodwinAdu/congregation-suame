...
import { addPayment } from "@/lib/actions/transport.actions"
...
export function PaymentModal({ open, onClose, member, onSuccess }: PaymentModalProps) {
    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        try {
            await addPayment(member._id, values.paymentAmount)
        ...
        <Dialog open={open} onOpenChange={onClose}>
            <DialogContent className="sm:max-w-[500px] w-[96%]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Add a payment for {member.fullName}
                    </DialogDescription>
                </DialogHeader>
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <div className="bg-blue-50 p-3 rounded-lg">
                            <p className="text-sm text-blue-800">
                                <strong>Note:</strong> Maximum payment allowed: ₵{currentBalance}
                            </p>
                        </div>
